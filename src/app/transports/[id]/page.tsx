...
import { getFirstImageUrlInFolder, sanitizeKey, listImageUrlsForPrefix } from "@/lib/r2";
    ...
    <main className="md:container my-2 px-7"> 
      ...
      <div className="">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-4 text-black/70">
          ...
          {!!transport.passengers && <span>• {transport.passengers} seats</span>}
          <span>
          ...
          <div className="rounded-lg border border-gray-200 p-5 shadow-sm sticky top-24">
            ...
            <div className="mt-4 text-sm text-black/80 flex flex-col space-y-2">
              <div className="flex items-center justify-between">
                <span>Capacity</span>
                <span className="font-medium">{transport.passengers ?? "-"}</span>
              </div>
              <div className="flex items-center justify-between">
                <span>Status</span>
      ...
      {/* Enquiry form */}
      <div id="enquire" className="mt-12">
